...
| Sophon release package | `docker compose -f docker-compose.sophon.yml run --rm cosmo-sophon-package [--chip <model>]`, or `.\scripts\build_sophon_package.ps1 [-Chip <model>]` on Windows; models are `bm1688` / `cv186x`, defaulting to `bm1688` |
